...
\begin{tikzpicture}[scale=0.9]
  ...
  % Add role labels
  \node[font=\sffamily\bfseries\small, color=role1, align=center] at (2.25,2.3) {Designated\\Leadership};
  \node[font=\sffamily\bfseries\small, color=role2, align=center] at (6.75,2.3) {Active\\Followership};
  \node[font=\sffamily\bfseries\small, color=role3, align=center] at (2.25,5.3) {Peer\\Leadership};
  \node[font=\sffamily\bfseries\small, color=role4, align=center] at (6.75,5.3) {Self\\Leadership};

  % Add brief descriptions
  \node[font=\footnotesize, align=center, text width=3.5cm] at (2.25,0.9) {Architect of\\group process};
  \node[font=\footnotesize, align=center, text width=3.5cm] at (6.75,0.9) {Support \&\\follow others};
  \node[font=\footnotesize, align=center, text width=3.5cm] at (2.25,3.9) {Shared\\responsibility};
  \node[font=\footnotesize, align=center, text width=3.5cm] at (6.75,3.9) {Character \&\\influence};
